...
__all__ = ['simplicial_subcomplex_2_hypergraph_incidence_matrix',
           'simplicial_complex_2_hypergraph',
           'graph_2_neighborhood_hypergraph','pointcloud_2_knn_graph',
           'graph_2_k_hop_hypergraph','graph_2_k_hop_hypergraph',
           'simplicial_complex_closure_of_hypergraph','distance_matrix_2_knn_hypergraph'
           ,'distance_matrix_2_knn_graph','distance_matrix_2_eps_neighborhood_hypergraph'
           ]
...
def simplicial_subcomplex_2_hypergraph_incidence_matrix(simplicial_complex, nodes_dim , edges_dim ):
    """
    Parameters
    ----------
    ...
    _nodes = simplicial_complex.dic_order_faces(nodes_dim) # maintain the same order stored in the SC
    _edges = simplicial_complex.dic_order_faces(edges_dim) # maintain the same order stored in the SC
    graph = []
