...
def _separate(
    ...
    if isinstance(value, Tensor):
        ...
        and isinstance(any_not_none(v[0] for v in value), (Tensor, SparseTensor))
    ):
        ...
        return [
            ...
            elem[idx]  # should be the same as elem is a Sequence of tensors
        ...
        and isinstance(any_not_none(value), (Tensor, SparseTensor))
    ):
...
def any_not_none(value: Iterable):
    for v in value:
        if v is not None:
            return v
    return None
