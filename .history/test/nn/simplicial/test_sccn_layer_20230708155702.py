...
class TestSCCNLayer:
    ...
    def test_forward(self):
        ...
        incidences = {"rank_0": torch.randint(0, 2, (n_rank_1_cells, n_rank_0_cells)).float(), 
                      "rank_1": torch.randint(0, 2, (n_rank_1_cells, n_rank_0_cells)).float()}
                      
        adjacencies = {"rank_0": torch.randint(0, 2, (n_rank_0_cells, n_rank_0_cells)).float(), 
                       "rank_1": torch.randint(0, 2, (n_rank_1_cells, n_rank_1_cells)).float()}
